...
const SetupNpm = () => {
  return (
    <div className='px-10'>
      ...
      <Image src='/rv1.png' className='my-5 rounded-md border border-slate-8' layout='responsive' width={100} height={100} alt='cra-install'/>
      ...
      <Image src='/rv2.png' className='my-5 rounded-md border border-slate-8' layout='responsive' width={100} height={100} alt='cra-install'/>
      ...
      <Image src='/rv3.png' className='my-5 rounded-md border border-slate-8' layout='responsive' width={100} height={100} alt='cra-install'/>
      ...
      <Image src='/rv4.png' className='my-5 rounded-md border border-slate-8' layout='responsive' width={100} height={100} alt='cra-install'/>
      ...
      <Image src='/rv5.png' className='my-5 rounded-md border border-slate-8' layout='responsive' width={100} height={100} alt='cra-install'/>
      ...
      <Image src='/rv6.png' className='my-5 rounded-md border border-slate-8' layout='responsive' width={100} height={100} alt='cra-install'/>
      ...
      <Image src='/rv7.png' className='my-5 rounded-md border border-slate-8' layout='responsive' width={100} height={100} alt='cra-install'/>
