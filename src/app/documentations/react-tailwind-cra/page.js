...
const SetupNpm = () => {
  return (
    <div className='px-10'>
      ...
      <Image src='/rt1.png' width={100} height={100} layout='responsive' className='my-10 rounded-md border border-slate-8'/>
      ...
      <Image src='/rt3.png' className='my-5 rounded-md border border-slate-8' width={100} height={100} layout='responsive' alt='cra-install'/>
      ...
      <Image src='/rt4.png' className='my-5 rounded-md border border-slate-8' width={100} height={100} layout='responsive' alt='cra-install'/>
      ...
      <Image src='/rt5.png' className='my-5 rounded-md border border-slate-8' width={100} height={100} layout='responsive' alt='cra-install'/>
      ...
      <Image src='/rt6.png' className='my-5 rounded-md border border-slate-8' width={100} height={100} layout='responsive' alt='cra-install'/>
      ...
      <Image src='/rt7.png' className='my-5 rounded-md border border-slate-8' width={100} height={100} layout='responsive' alt='cra-install'/>
