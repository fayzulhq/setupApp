...
const SetupNpm = () => {
  return (
    <div className='px-10'>
      ...
      <Image src='/rt1.png' width={100} height={100} className='my-10 rounded-md border border-slate-8'/>
      ...
      <Image src='/rt2.png' className='mb-5 rounded-md border border-slate-8' width={100} height={100} alt='cra-install'/>

      <ParagraphSection text="Then, install TailwindCSS as a development dependency using npm:" className='mb-5'/>

      <Image src='/rt3.png' className='my-5 rounded-md border border-slate-8' width={100} height={100} alt='cra-install'/>
      ...
      <Image src='/rt4.png' className='my-5 rounded-md border border-slate-8' width={100} height={100} alt='cra-install'/>
      ...
      <Image src='/rt5.png' className='my-5 rounded-md border border-slate-8' width={100} height={100} alt='cra-install'/>
      ...
      <Image src='/rt6.png' className='my-5 rounded-md border border-slate-8' width={100} height={100} alt='cra-install'/>
      ...
      <Image src='/rt7.png' className='my-5 rounded-md border border-slate-8' width={100} height={100} alt='cra-install'/>
